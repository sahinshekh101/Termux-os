...
clear;toilet -t -f mono12  "sahin101" --gay -F border
echo ""
PUT 11 40
echo -e "\e[92mBy\e[1;93m SAHIN\e[1;95m /\e[1;96m SHEKH "
PUT 12 3
echo ""
echo -e "\e[1;31m  [\e[32m√\e[31m] \e[1;91m by \e[1;36mSAHIN SHEKH"
echo
...
sed -e "s/\sahin101/$name/g" .sahin101.zsh-theme > $HOME/.oh-my-zsh/themes/sahin101.zsh-theme
